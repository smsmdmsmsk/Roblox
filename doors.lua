...
local ESPTabBox = Tabs.Visuals:AddLeftTabbox() do
    ...
    local ESPSettingsTab = ESPTabBox:AddTab("Settings") do
        ...
        ESPSettingsTab:AddToggle("ESP彩虹", {
            Text = "彩虹ESP",
            Default = false,
        })
    
        ESPSettingsTab:AddToggle("ESP距离", {
            Text = "显示距离",
            Default = true
        })
    
        ESPSettingsTab:AddSlider(" ESP填充透明度", {
            Text = "透明度柜子",
            Default = 0.75,
            Min = 0,
            Max = 1,
        ...
        ESPSettingsTab:AddSlider(" ESP大柜透明度", {
            Text = "大柜子透明度",
            Default = 0,
            Min = 0,
            Max = 1,
        ...
        ESPSettingsTab:AddSlider("ESP文字大小", {
            Text = "文字大小",
            Default = 22,
            Min = 16,
            Max = 26,
...
local NotifyTabBox = Tabs.Visuals:AddRightTabbox() do
    local NotifyTab = NotifyTabBox:AddTab("Notifier") do
        NotifyTab:AddDropdown("NotifyEntity", {
            AllowNull = true,
            Values = {"Blitz", "Lookman", "臭rush", "来两次的怪", "Eyes", "A60", "A120", "Jeff The Killer", "Gloombat Swarm"},
            Default = {},
            Multi = true,
...
MenuGroup:AddButton("Join Discord Server", function()
    ...
    Inviter.Prompt({
        name = "QQ",
        invite = http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=M-g6H1LwSh22kxIVDVoiE6_ARrn1i36d&authKey=V3jGo%2FNHFfE%2BvWKwI5omLx7PBiIfL7LIaTXN1A2nHSZQ21ixaQumxIlJe7utIU8O&noverify=0&group_code=993659706",
    })
end)
...
CreditsGroup:AddLabel("老大 - main script dev")
CreditsGroup:AddLabel("老大")
CreditsGroup:AddLabel("孙笑川")
