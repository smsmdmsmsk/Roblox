...
spawn(function()
    while task.wait() do
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.Text = "林脚本nb"
...
game:GetService("Workspace").Stores.WoodRUs.Parts.OPEN24HOURS.SurfaceGui.TextLabel.Text = "作者:林";
game:GetService("Workspace").Stores.WoodRUs.Parts.OPEN24HOURS.SurfaceGui.TextLabel.TextColor3 =
    Color3.fromRGB(255, 0, 0)
game:GetService("Workspace").Stores.WoodRUs.Parts.SELLWOOD.SurfaceGui.TextLabel.Text = "作者:林";
...
local function donate(plr, amount)
    ...
    notify('林', '转钱' .. tostring(amount) .. ' 给 ' .. tostring(plr), 4);
    scr2.exitNotice();
end
...
local window = Cloudlib:new("林伐木大亨2", '')
local Tab1 = window:Tab("玩家功能", "15613380753")
...
local Tab = window:Tab("主要功能", "15613380753")
...
local Tab2 = window:Tab("环境", "15613380753")
local Sectionhuanjin = Tab2:section("环境", false)
local Tab4 = window:Tab("魔鬼功能", "15613380753")
local Sectionmogui = Tab4:section("魔鬼功能(慎用)", false)
local Tab5 = window:Tab("自动购买", "15613380753")
...
Section:Button("获取当前死亡后加载时间", function()
    bailib:Notification("林", " 时间为" .. bai.loaddupeaxewaittime .. "秒", "好")
end)
...
Sectionbringtree:Dropdown("选择树", 'Dropdown',
    {"普通树", '幻影木', "沼泽黄金", "樱花", "蓝木", "冰木", "火山木", "橡木", "巧克力木",
     "林桦木", "黄金木", "雪地松", "僵尸木", "大巧克力树", "椰子树", '南瓜木', '幽灵木'},
    function(b)
        if b == '普通树' then
...
local drop = Sectionzhenglimt:Dropdown("选择木头类型", 'Dropdown',
    {"普通树", "沼泽黄金", "樱花", "蓝木", "冰木", "火山木", "橡木", "巧克力木", "林桦木",
...
Sectionhuanjin:Toggle("终日林天", 'Toggleflag', false, function(state)
    if state then
        bai.awaysday = true
        while task.wait() do
...
Sectionhuanjin:Button("船离开时间", function()
    ...
    if game.Workspace.Ferry.TimeToDeparture.Value == 0 then
        ...
        notify("林", "距离船离开时间有" .. game.Workspace.Ferry.TimeToDeparture.Value .. "秒", 4)
    end
end)
Sectionhuanjin:Button("桥上升时间", function()
    ...
    if game.Workspace.Bridge.DownTime.Value < 0 then
        ...
        notify("林", "距离桥上升的时间有" .. game.Workspace.Bridge.DownTime.Value .. "秒", 4)
    end
end)
Sectionhuanjin:Button("查看游戏时间", function()
    notify("林", "游戏时间为" .. tostring(game.Lighting.TimeOfDay):sub(1, -2):sub(1, -2):sub(1, -2), 4)
end)
...
end)local CoreGui = game:GetService("StarterGui") 
