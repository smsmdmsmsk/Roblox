...
local function QXLQ_fake_script()
...
local function QDJMGZT_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground)
...
local function WIHGV_fake_script()
	local script = Instance.new('Script', nil)
end
coroutine.wrap(WIHGV_fake_script)()
local function WVKVQ_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground)
...
local function EBDG_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground)
...
local function WNGTYNL_fake_script()
...
local function OMOBYOH_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground_2)
...
local function TBIHN_fake_script()
	local script = Instance.new('Script', nil)
end
coroutine.wrap(TBIHN_fake_script)()
local function TMDOH_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground_2)
...
local function UBFW_fake_script()
	local script = Instance.new('Script', nil)
end
coroutine.wrap(UBFW_fake_script)()
local function ENDVDH_fake_script()
	local script = Instance.new('LocalScript', SwitchBackground_2)
...
local function IGFYUIK_fake_script()
